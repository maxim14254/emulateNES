...
QDataStream &operator<<(QDataStream &out, const Mapper_2 &mapper)
{
    out << mapper.reg_prg;
    out << mapper.total_prg_banks;
...
QDataStream &operator>>(QDataStream &in, Mapper_2 &mapper)
{
    in >> mapper.reg_prg;
    in >> mapper.total_prg_banks;
