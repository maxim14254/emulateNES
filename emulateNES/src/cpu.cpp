...
CPU::CPU(MainWindow* _window, Bus* _bus) : window(_window), bus(_bus)
{
    ...
    table_instructions[0x01] = { &CPU::ORA_indX, "ORA", "IZX"};
    table_instructions[0x02] = { &CPU::KIL_imp, "KIL", "IMP" };
    table_instructions[0x03] = { &CPU::SLO_indX, "SLO", "IZX" };
    table_instructions[0x04] = { &CPU::NOP_zp_04, "NOP", "ZP0" };
    table_instructions[0x05] = { &CPU::ORA_zp, "ORA", "ZP0" };
    table_instructions[0x06] = { &CPU::ASL_zp, "ASL", "ZP0" };
    table_instructions[0x07] = { &CPU::SLO_zp, "SLO", "ZP0" };
    table_instructions[0x08] = { &CPU::PHP_impl, "PHP", "IMP"  };
    table_instructions[0x09] = { &CPU::ORA_imm, "ORA", "IMM" };
    table_instructions[0x0A] = { &CPU::ASL_A, "ASL", "IMP"  };
    table_instructions[0x0B] = { &CPU::ANC_imm, "ANC", "IMM" };
    table_instructions[0x0C] = { &CPU::NOP_abs, "NOP", "ABS" };
    table_instructions[0x0D] = { &CPU::ORA_abs, "ORA", "ABS"  };
    table_instructions[0x0E] = { &CPU::ASL_abs, "ASL", "ABS"   };
    table_instructions[0x0F] = { &CPU::SLO_abs, "SLO", "ABS"  };

    table_instructions[0x10] = { &CPU::BPL_rel, "BPL", "REL" };
    table_instructions[0x11] = { &CPU::ORA_indY, "ORA","IZY" };
    table_instructions[0x12] = { &CPU::KIL_imp, "KIL", "IMP" };
    table_instructions[0x13] = { &CPU::SLO_indY, "SLO","IZY" };
    table_instructions[0x14] = { &CPU::NOP_zpX_14, "NOP", "ZPX" };
    table_instructions[0x15] = { &CPU::ORA_zpX, "ORA", "ZPX" };
    table_instructions[0x16] = { &CPU::ASL_zpX, "ASL", "ZPX"  };
    table_instructions[0x17] = { &CPU::SLO_zpX, "SLO", "ZPX" };
    table_instructions[0x18] = { &CPU::CLC_impl, "CLC", "IMP"   };
    table_instructions[0x19] = { &CPU::ORA_absY, "ORA", "ABY" };
    table_instructions[0x1A] = { &CPU::NOP_imm_1A, "NOP", "IMP"  };
    table_instructions[0x1B] = { &CPU::SLO_absY, "SLO", "ABY"  };
    table_instructions[0x1C] = { &CPU::NOP_absX_1C, "NOP", "ABX"  };
    table_instructions[0x1D] = { &CPU::ORA_absX, "ORA", "ABX"  };
    table_instructions[0x1E] = { &CPU::ASL_absX, "ASL", "ABX"   };
    table_instructions[0x1F] = { &CPU::SLO_absX, "SLO", "ABX"  };

    table_instructions[0x20] = { &CPU::JSR_abs, "JSR", "ABS"   };
    table_instructions[0x21] = { &CPU::AND_indX, "AND", "IZX"  };
    table_instructions[0x22] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0x23] = { &CPU::RLA_indX, "RLA", "IZX"  };
    table_instructions[0x24] = { &CPU::BIT_zp, "BIT", "ZP0"  };
    table_instructions[0x25] = { &CPU::AND_zp, "AND", "ZP0"   };
    table_instructions[0x26] = { &CPU::ROL_zp, "ROL", "ZP0"  };
    table_instructions[0x27] = { &CPU::RLA_zp, "RLA", "ZP0"  };
    table_instructions[0x28] = { &CPU::PLP_impl, "PLP", "IMP"   };
    table_instructions[0x29] = { &CPU::AND_imm, "AND", "IMM"   };
    table_instructions[0x2A] = { &CPU::ROL_A, "ROL", "IMP"   };
    table_instructions[0x2B] = { &CPU::ANC_imm, "ANC", "IMM"  };
    table_instructions[0x2C] = { &CPU::BIT_abs, "BIT", "ABS"   };
    table_instructions[0x2D] = { &CPU::AND_abs, "AND", "ABS"    };
    table_instructions[0x2E] = { &CPU::ROL_abs, "ROL", "ABS"   };
    table_instructions[0x2F] = { &CPU::RLA_abs, "RLA", "ABS"   };

    table_instructions[0x30] = { &CPU::BMI_rel, "BMI", "REL"  };
    table_instructions[0x31] = { &CPU::AND_indY, "AND","IZY"   };
    table_instructions[0x32] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0x33] = { &CPU::RLA_indY, "RLA","IZY"  };
    table_instructions[0x34] = { &CPU::NOP_zpX_34, "NOP", "ZPX"  };
    table_instructions[0x35] = { &CPU::AND_zpX, "AND", "ZPX"   };
    table_instructions[0x36] = { &CPU::ROL_zpX, "ROL", "ZPX"  };
    table_instructions[0x37] = { &CPU::RLA_zpX, "RLA", "ZPX"  };
    table_instructions[0x38] = { &CPU::SEC_impl, "SEC", "IMP"   };
    table_instructions[0x39] = { &CPU::AND_absY, "AND", "ABY"   };
    table_instructions[0x3A] = { &CPU::NOP_imm_3A, "NOP", "IMP"  };
    table_instructions[0x3B] = { &CPU::RLA_absY, "RLA", "ABY"  };
    table_instructions[0x3C] = { &CPU::NOP_absX_3C, "NOP", "ABX"  };
    table_instructions[0x3D] = { &CPU::AND_absX, "AND", "ABX"   };
    table_instructions[0x3E] = { &CPU::ROL_absX, "ROL", "ABX"  };
    table_instructions[0x3F] = { &CPU::RLA_absX, "RLA", "ABX"  };

    table_instructions[0x40] = { &CPU::RTI_impl, "RTI", "IMP"   };
    table_instructions[0x41] = { &CPU::EOR_indX, "EOR", "IZX"  };
    table_instructions[0x42] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0x43] = { &CPU::SRE_indX, "SRE", "IZX"  };
    table_instructions[0x44] = { &CPU::NOP_zp_44, "NOP", "ZP0"  };
    table_instructions[0x45] = { &CPU::EOR_zp, "EOR", "ZP0"   };
    table_instructions[0x46] = { &CPU::LSR_zp, "LSR", "ZP0"  };
    table_instructions[0x47] = { &CPU::SRE_zp, "SRE", "ZP0"  };
    table_instructions[0x48] = { &CPU::PHA_impl, "PHA", "IMP" };
    table_instructions[0x49] = { &CPU::EOR_imm, "EOR", "IMM"   };
    table_instructions[0x4A] = { &CPU::LSR_A, "LSR", "IMP"   };
    table_instructions[0x4B] = { &CPU::ALR_imm, "ALR", "IMM"  };
    table_instructions[0x4C] = { &CPU::JMP_abs, "JMP", "ABS"   };
    table_instructions[0x4D] = { &CPU::EOR_abs, "EOR", "ABS"    };
    table_instructions[0x4E] = { &CPU::LSR_abs, "LSR", "ABS"   };
    table_instructions[0x4F] = { &CPU::SRE_abs, "SRE", "ABS"   };

    table_instructions[0x50] = { &CPU::BVC_rel, "BVC", "REL"  };
    table_instructions[0x51] = { &CPU::EOR_indY, "EOR","IZY"   };
    table_instructions[0x52] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0x53] = { &CPU::SRE_indY, "SRE","IZY"  };
    table_instructions[0x54] = { &CPU::NOP_zpX_54, "NOP", "ZPX"  };
    table_instructions[0x55] = { &CPU::EOR_zpX, "EOR", "ZPX"   };
    table_instructions[0x56] = { &CPU::LSR_zpX, "LSR", "ZPX"  };
    table_instructions[0x57] = { &CPU::SRE_zpX, "SRE", "ZPX"  };
    table_instructions[0x58] = { &CPU::CLI_impl, "CLI", "IMP" };
    table_instructions[0x59] = { &CPU::EOR_absY, "EOR", "ABY"   };
    table_instructions[0x5A] = { &CPU::NOP_imm_5A, "NOP", "IMP"  };
    table_instructions[0x5B] = { &CPU::SRE_absY, "SRE", "ABY"  };
    table_instructions[0x5C] = { &CPU::NOP_absX_5C, "NOP", "ABX"  };
    table_instructions[0x5D] = { &CPU::EOR_absX, "EOR", "ABX"   };
    table_instructions[0x5E] = { &CPU::LSR_absX, "LSR", "ABX"  };
    table_instructions[0x5F] = { &CPU::SRE_absX, "SRE", "ABX"  };

    table_instructions[0x60] = { &CPU::RTS_impl, "RTS", "IMP" };
    table_instructions[0x61] = { &CPU::ADC_indX, "ADC", "IZX"  };
    table_instructions[0x62] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0x63] = { &CPU::RRA_indX, "RRA", "IZX"  };
    table_instructions[0x64] = { &CPU::NOP_zp_64, "NOP", "ZP0"  };
    table_instructions[0x65] = { &CPU::ADC_zp, "ADC", "ZP0"  };
    table_instructions[0x66] = { &CPU::ROR_zp, "ROR", "ZP0"  };
    table_instructions[0x67] = { &CPU::RRA_zp, "RRA", "ZP0"   };
    table_instructions[0x68] = { &CPU::PLA_impl, "PLA", "IMP" };
    table_instructions[0x69] = { &CPU::ADC_imm, "ADC", "IMM"  };
    table_instructions[0x6A] = { &CPU::ROR_A, "ROR", "IMP"    };
    table_instructions[0x6B] = { &CPU::ARR_imm, "ARR", "IMM"  };
    table_instructions[0x6C] = { &CPU::JMP_ind, "JMP", "IND"  };
    table_instructions[0x6D] = { &CPU::ADC_abs, "ADC", "ABS"   };
    table_instructions[0x6E] = { &CPU::ROR_abs, "ROR", "ABS" };
    table_instructions[0x6F] = { &CPU::RRA_abs, "RRA", "ABS" };

    table_instructions[0x70] = { &CPU::BVS_rel, "BVS", "REL"  };
    table_instructions[0x71] = { &CPU::ADC_indY, "ADC","IZY"  };
    table_instructions[0x72] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0x73] = { &CPU::RRA_indY, "RRA","IZY"   };
    table_instructions[0x74] = { &CPU::NOP_zpX_74, "NOP", "ZPX"  };
    table_instructions[0x75] = { &CPU::ADC_zpX, "ADC", "ZPX"  };
    table_instructions[0x76] = { &CPU::ROR_zpX, "ROR", "ZPX"   };
    table_instructions[0x77] = { &CPU::RRA_zpX, "RRA", "ZPX"   };
    table_instructions[0x78] = { &CPU::SEI_impl, "SEI", "IMP"};
    table_instructions[0x79] = { &CPU::ADC_absY, "ADC", "ABY"  };
    table_instructions[0x7A] = { &CPU::NOP_imm_7A, "NOP", "IMP"  };
    table_instructions[0x7B] = { &CPU::RRA_absY, "RRA", "ABY"  };
    table_instructions[0x7C] = { &CPU::NOP_absX_7C, "NOP", "ABX"  };
    table_instructions[0x7D] = { &CPU::ADC_absX, "ADC", "ABX"  };
    table_instructions[0x7E] = { &CPU::ROR_absX, "ROR", "ABX"   };
    table_instructions[0x7F] = { &CPU::RRA_absX, "RRA", "ABX"   };

    table_instructions[0x80] = { &CPU::NOP_imm_80, "NOP", "IMM"  };
    table_instructions[0x81] = { &CPU::STA_indX, "STA", "IZX"  };
    table_instructions[0x82] = { &CPU::NOP_imm_80, "NOP", "IMM"  };
    table_instructions[0x83] = { &CPU::SAX_indX, "SAX", "IZX"  };
    table_instructions[0x84] = { &CPU::STY_zp, "STY", "ZP0"  };
    table_instructions[0x85] = { &CPU::STA_zp, "STA", "ZP0"  };
    table_instructions[0x86] = { &CPU::STX_zp, "STX", "ZP0"  };
    table_instructions[0x87] = { &CPU::SAX_zp, "SAX", "ZP0"  };
    table_instructions[0x88] = { &CPU::DEY_impl, "DEY", "IMP"  };
    table_instructions[0x89] = { &CPU::BIT_imm, "BIT", "IMM"  };
    table_instructions[0x8A] = { &CPU::TXA_impl, "TXA", "IMP"  };
    table_instructions[0x8B] = { &CPU::XAA_imm, "XAA", "IMM"  };
    table_instructions[0x8C] = { &CPU::STY_abs, "STY", "ABS"   };
    table_instructions[0x8D] = { &CPU::STA_abs, "STA", "ABS"   };
    table_instructions[0x8E] = { &CPU::STX_abs, "STX", "ABS"   };
    table_instructions[0x8F] = {&CPU::SAX_abs, "SAX", "ABS"   };

    table_instructions[0x90] = { &CPU::BCC_rel, "BCC", "REL"  };
    table_instructions[0x91] = { &CPU::STA_indY, "STA","IZY"  };
    table_instructions[0x92] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0x93] = { &CPU::AHX_indY, "AHX","IZY"   };
    table_instructions[0x94] = { &CPU::STY_zpX, "STY", "ZPX"  };
    table_instructions[0x95] = { &CPU::STA_zpX, "STA", "ZPX"  };
    table_instructions[0x96] = { &CPU::STX_zpY, "STX", "ZPY"  };
    table_instructions[0x97] = { &CPU::SAX_zpY, "SAX", "ZPY"  };
    table_instructions[0x98] = { &CPU::TYA_impl, "TYA", "IMP"  };
    table_instructions[0x99] = { &CPU::STA_absY, "STA", "ABY"  };
    table_instructions[0x9A] = { &CPU::TXS_impl, "TXS", "IMP" };
    table_instructions[0x9B] = { &CPU::TAS_absY, "TAS", "ABY"  };
    table_instructions[0x9C] = { &CPU::SHY_absX, "SHY", "ABX"  };
    table_instructions[0x9D] = { &CPU::STA_absX, "STA", "ABX"  };
    table_instructions[0x9E] = { &CPU::SHX_absY, "SHX", "ABY"  };
    table_instructions[0x9F] = { &CPU::AHX_absY, "AHX", "ABY"  };

    table_instructions[0xA0] = { &CPU::LDY_imm, "LDY", "IMM"  };
    table_instructions[0xA1] = { &CPU::LDA_indX, "LDA", "IZX"  };
    table_instructions[0xA2] = { &CPU::LDX_imm, "LDX", "IMM"  };
    table_instructions[0xA3] = { &CPU::LAX_indX, "LAX", "IZX"  };
    table_instructions[0xA4] = { &CPU::LDY_zp, "LDY", "ZP0"  };
    table_instructions[0xA5] = { &CPU::LDA_zp, "LDA", "ZP0"  };
    table_instructions[0xA6] = { &CPU::LDX_zp, "LDX", "ZP0"  };
    table_instructions[0xA7] = { &CPU::LAX_zp, "LAX", "ZP0"  };
    table_instructions[0xA8] = { &CPU::TAY_impl, "TAY", "IMP"  };
    table_instructions[0xA9] = { &CPU::LDA_imm, "LDA", "IMM"  };
    table_instructions[0xAA] = { &CPU::TAX_impl, "TAX", "IMP"  };
    table_instructions[0xAB] = { &CPU::LAX_imm, "LAX", "IMM"  };
    table_instructions[0xAC] = { &CPU::LDY_abs, "LDY", "ABS"   };
    table_instructions[0xAD] = { &CPU::LDA_abs, "LDA", "ABS"   };
    table_instructions[0xAE] = { &CPU::LDX_abs, "LDX", "ABS"   };
    table_instructions[0xAF] = { &CPU::LAX_abs, "LAX", "ABS"   };

    table_instructions[0xB0] = { &CPU::BCS_rel, "BCS", "REL"  };
    table_instructions[0xB1] = { &CPU::LDA_indY, "LDA","IZY"  };
    table_instructions[0xB2] = { &CPU::KIL_imp, "KIL", "IMP"  };
    table_instructions[0xB3] = { &CPU::LAX_indY, "LAX","IZY"  };
    table_instructions[0xB4] = { &CPU::LDY_zpX, "LDY", "ZPX"  };
    table_instructions[0xB5] = { &CPU::LDA_zpX, "LDA", "ZPX"  };
    table_instructions[0xB6] = { &CPU::LDX_zpY, "LDX", "ZPY"  };
    table_instructions[0xB7] = { &CPU::LAX_zpY, "LAX", "ZPY"  };
    table_instructions[0xB8] = { &CPU::CLV_impl, "CLV", "IMP" };
    table_instructions[0xB9] = { &CPU::LDA_absY, "LDA", "ABY" };
    table_instructions[0xBA] = { &CPU::TSX_impl, "TSX", "IMP" };
    table_instructions[0xBB] = { &CPU::LAS_absY, "LAS", "ABY" };
    table_instructions[0xBC] = { &CPU::LDY_absX, "LDY", "ABX" };
    table_instructions[0xBD] = { &CPU::LDA_absX, "LDA", "ABX" };
    table_instructions[0xBE] = { &CPU::LDX_absY, "LDX", "ABY" };
    table_instructions[0xBF] = { &CPU::LAX_absY, "LAX", "ABY" };

    table_instructions[0xC0] = { &CPU::CPY_imm, "CPY", "IMM" };
    table_instructions[0xC1] = { &CPU::CMP_indX, "CMP", "IZX" };
    table_instructions[0xC2] = { &CPU::NOP_imm_80, "NOP", "IMM" };
    table_instructions[0xC3] = { &CPU::DCP_indX, "DCP", "IZX" };
    table_instructions[0xC4] = { &CPU::CPY_zp, "CPY", "ZP0" };
    table_instructions[0xC5] = { &CPU::CMP_zp, "CMP", "ZP0" };
    table_instructions[0xC6] = { &CPU::DEC_zp, "DEC", "ZP0" };
    table_instructions[0xC7] = { &CPU::DCP_zp, "DCP", "ZP0"  };
    table_instructions[0xC8] = { &CPU::INY_impl, "INY", "IMP" };
    table_instructions[0xC9] = { &CPU::CMP_imm, "CMP", "IMM" };
    table_instructions[0xCA] = { &CPU::DEX_impl, "DEX", "IMP" };
    table_instructions[0xCB] = { &CPU::SAX_imm, "SAX", "IMM" };
    table_instructions[0xCC] = { &CPU::CPY_abs, "CPY", "ABS"  };
    table_instructions[0xCD] = { &CPU::CMP_abs, "CMP", "ABS"  };
    table_instructions[0xCE] = { &CPU::DEC_abs, "DEC", "ABS"   };
    table_instructions[0xCF] = { &CPU::DCP_abs, "DCP", "ABS"   };

    table_instructions[0xD0] = { &CPU::BNE_rel, "BNE", "REL" };
    table_instructions[0xD1] = { &CPU::CMP_indY, "CMP","IZY" };
    table_instructions[0xD2] = { &CPU::KIL_imp, "KIL", "IMP" };
    table_instructions[0xD3] = { &CPU::DCP_indY, "DCP","IZY"  };
    table_instructions[0xD4] = { &CPU::NOP_zpX_D4, "NOP", "ZPX" };
    table_instructions[0xD5] = { &CPU::CMP_zpX, "CMP", "ZPX" };
    table_instructions[0xD6] = { &CPU::DEC_zpX, "DEC", "ZPX"  };
    table_instructions[0xD7] = { &CPU::DCP_zpX, "DCP", "ZPX"  };
    table_instructions[0xD8] = { &CPU::CLD_impl, "CLD", "IMP" };
    table_instructions[0xD9] = { &CPU::CMP_absY, "CMP", "ABY" };
    table_instructions[0xDA] = { &CPU::NOP_impl_DA, "NOP", "IMP" };
    table_instructions[0xDB] = { &CPU::DCP_absY, "DCP", "ABY"  };
    table_instructions[0xDC] = { &CPU::NOP_absX_DC, "NOP", "ABX" };
    table_instructions[0xDD] = { &CPU::CMP_absX, "CMP", "ABX" };
    table_instructions[0xDE] = { &CPU::DEC_absX, "DEC", "ABX"  };
    table_instructions[0xDF] = { &CPU::DCP_absX, "DCP", "ABX"  };

    table_instructions[0xE0] = { &CPU::CPX_imm, "CPX", "IMM" };
    table_instructions[0xE1] = { &CPU::SBC_indX, "SBC", "IZX" };
    table_instructions[0xE2] = { &CPU::NOP_imm_80, "NOP", "IMM" };
    table_instructions[0xE3] = { &CPU::ISC_indX, "ISC", "IZX" };
    table_instructions[0xE4] = { &CPU::CPX_zp, "CPX", "ZP0" };
    table_instructions[0xE5] = { &CPU::SBC_zp, "SBC", "ZP0"  };
    table_instructions[0xE6] = { &CPU::INC_zp, "INC", "ZP0" };
    table_instructions[0xE7] = { &CPU::ISC_zp, "ISC", "ZP0" };
    table_instructions[0xE8] = { &CPU::INX_impl, "INX", "IMP" };
    table_instructions[0xE9] = { &CPU::SBC_imm_E9, "SBC", "IMM"   };
    table_instructions[0xEA] = { &CPU::NOP_impl_EA, "NOP", "IMP" };
    table_instructions[0xEB] = { &CPU::SBC_imm_EB, "SBC", "IMM"   };
    table_instructions[0xEC] = { &CPU::CPX_abs, "CPX", "ABS"  };
    table_instructions[0xED] = { &CPU::SBC_abs, "SBC", "ABS"   };
    table_instructions[0xEE] = { &CPU::INC_abs, "INC", "ABS"   };
    table_instructions[0xEF] = { &CPU::ISC_abs, "ISC", "ABS"  };

    table_instructions[0xF0] = { &CPU::BEQ_rel, "BEQ", "REL" };
    table_instructions[0xF1] = { &CPU::SBC_indY, "SBC","IZY"  };
    table_instructions[0xF2] = { &CPU::KIL_imp, "KIL", "IMP" };
    table_instructions[0xF3] = { &CPU::ISC_indY, "ISC","IZY" };
    table_instructions[0xF4] = { &CPU::NOP_zpX_F4, "NOP", "ZPX"  };
    table_instructions[0xF5] = { &CPU::SBC_zpX, "SBC", "ZPX"  };
    table_instructions[0xF6] = { &CPU::INC_zpX, "INC", "ZPX"  };
    table_instructions[0xF7] = { &CPU::ISC_zpX, "ISC", "ZPX" };
    table_instructions[0xF8] = { &CPU::SED_impl, "SED", "IMP" };
    table_instructions[0xF9] = { &CPU::SBC_absY, "SBC", "ABY"  };
    table_instructions[0xFA] = { &CPU::NOP_impl_FA, "NOP", "IMP" };
    table_instructions[0xFB] = { &CPU::ISC_absY, "ISC", "ABY" };
    table_instructions[0xFC] = { &CPU::NOP_absX_FC, "NOP", "ABX" };
    table_instructions[0xFD] = { &CPU::SBC_absX, "SBC", "ABX"  };
    table_instructions[0xFE] = { &CPU::INC_absX, "INC", "ABX"  };
    table_instructions[0xFF] = { &CPU::ISC_absX, "ISC", "ABX" };
...
void CPU::ORA_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ORA $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ddd[] = { 0x11,
                      bus->read_cpu(old_PC + 1),
                      -1
                    }; //ORA ($33),Y = 0400 @ 0400 = AA

    LOG::Write(old_PC, ddd,
               QString("ORA ($%1),Y = %2 @ %3 = %4").
                    arg(bus->read_cpu(old_PC + 1), 2, 16,QLatin1Char('0')).toUpper().
...
void CPU::ORA_indX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ORA ($%1,X) @ %2 = %3 = %4").
                    arg(bus->read_cpu(old_PC + 1), 2, 16,QLatin1Char('0')).toUpper().
                    arg((bus->read_cpu(old_PC + 1) + X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().
                    arg(addr, 4, 16,QLatin1Char('0')).toUpper().
                    arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
...
void CPU::ASL_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ASL $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::AND_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("AND $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::AND_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("AND $%1%2,Y @ %3 = %4").arg((addr >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::ROL_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ROL $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::RTI_impl()
{
    ...
    uint8_t PCl = bus->read_cpu(0x0100 + ++SP);
    uint8_t PCh = bus->read_cpu(0x0100 + ++SP);
...
void CPU::EOR_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("EOR $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::LSR_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("LSR $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::JMP_ind()
{
    ...
    LOG::Write(old_PC, ddd, QString("JMP ($%1) = %2").arg(addr, 4, 16, QLatin1Char('0')).arg(PC, 4, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0x75, ss, -1}; //LDY $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("ADC $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr & 0xFF, 2, 16, QLatin1Char('0')).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::ADC_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ADC $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0x76, ss, -1}; //LDY $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("ROR $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr & 0xFF, 2, 16, QLatin1Char('0')).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::ROR_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ROR $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    uint8_t a1 = bus->read_cpu(old_PC + 1);
    int16_t ddd[] = { 0x81,
                      bus->read_cpu(old_PC + 1),
                      -1
                    }; //ORA ($80,X) @ 80 = 0200 = AA
...
void CPU::STA_indY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("STA ($%1),Y = %2 @ %3 = %4").
                   arg(bus->read_cpu(old_PC + 1), 2, 16,QLatin1Char('0')).toUpper().
                   arg((uint16_t)(addr - Y), 4, 16, QLatin1Char('0')).toUpper().
                   arg(addr, 4, 16, QLatin1Char('0')).toUpper().
                   arg(val, 2, 16 ,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0x95, ss, -1}; //LDY $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("STA $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr & 0xFF, 2, 16, QLatin1Char('0')).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::STA_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("STA $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0x94, ss, -1}; //LDY $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("STY $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr & 0xFF, 2, 16, QLatin1Char('0')).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::STY_abs()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("STY $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().
                    arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - Y) & 0xFF;
    int16_t ddd[] = {0x96, ss, -1}; //LDY $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("STX $%1,Y @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr & 0xFF, 2, 16, QLatin1Char('0')).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0xB4, ss, -1}; //LDY $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("LDY $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr & 0xFF, 2, 16, QLatin1Char('0')).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xAC, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("LDY $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(Y, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::LDY_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("LDY $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::LDA_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("LDA $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - Y) & 0xFF;
    int16_t ddd[] = {0xB6, ss, -1}; //LDY $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("LDX $%1,Y @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr & 0xFF, 2, 16, QLatin1Char('0')).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::LDX_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("LDX $%1%2,Y @ %3 = %4").arg(((addr - Y) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xCC, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("CPY $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xCD, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("CMP $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::CMP_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("CMP $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xCE, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("DEC $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::DEC_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("DEC $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    //val = std::abs(val);
    int16_t ddd[] = {0xD0, (uint8_t)val, -1};
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xEC, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("CPX $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xED, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("SBC $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::SBC_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("SBC $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xEE, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("INC $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::INC_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("INC $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x44, ss, -1}; //ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("NOP $%1 = %2").arg(ss, 2, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x64, ss, -1}; //ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("NOP $%1 = %2").arg(ss, 2, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0x14, ss, -1}; //LDA $10,X @ 20 = F
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0x54, ss, -1}; //LDA $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("NOP $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr, 2, 16).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0x74, ss, -1}; //LDA $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("NOP $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr, 2, 16).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0xD4, ss, -1}; //LDA $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("NOP $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr, 2, 16).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr - X) & 0xFF;
    int16_t ddd[] = {0xF4, ss, -1}; //LDA $10,X @ 20 = F
    LOG::Write(old_PC, ddd, QString("NOP $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr, 2, 16).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x0C, ss, (int16_t)((addr) >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("NOP $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}

void CPU::NOP_absX_1C()
{
#if LOG_ON
    uint16_t old_PC = PC;
    auto old_cycles = cycles;
    ...
    LOG::Write(old_PC, ddd,
               QString("NOP $%1,X @ %2%3 = %4").arg((addr - X), 4, 16,QLatin1Char('0')).toUpper().
               arg(addr >> 8, 2, 16,QLatin1Char('0')).toUpper().
               arg((addr) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().
               arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x0F, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("SLO $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::SLO_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("SLO $%1%2,Y @ %3 = %4").arg(((addr - Y) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::SLO_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("SLO $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x2F, ss, (int16_t)(addr >> 8)}; //ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("RLA $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::RLA_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("RLA $%1%2,Y @ %3 = %4").arg(((addr - Y) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::RLA_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("RLA $%1,X @ %2%3 = %4").arg((addr - X), 4, 16, QLatin1Char('0')).toUpper().
                    arg(addr >> 8, 2, 16, QLatin1Char('0')).toUpper().
                    arg((addr) & 0xFF, 2, 16, QLatin1Char('0')).toUpper().
                    arg(val, 2, 16, QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x4F, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("SRE $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::SRE_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("SRE $%1%2,Y @ %3 = %4").arg((addr - Y) >> 8, 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::SRE_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("SRE $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::RRA_zp()
{
    ...
    LOG::Write(old_PC, ddd, QString("RRA $%1 = %2").arg(ss, 2, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x6F, ss, (int16_t)(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("RRA $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::RRA_zpX()
{
    ...
    LOG::Write(old_PC, ddd, QString("RRA $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr, 2, 16).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::RRA_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("RRA $%1%2,Y @ %3 = %4").arg(((addr - Y) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::RRA_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("RRA $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xCF, ss, int16_t(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("DCP $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::DCP_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("DCP $%1%2,Y @ %3 = %4").arg(((addr - Y) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::DCP_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("DCP $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::ISC_zp()
{
    ...
    LOG::Write(old_PC, ddd, QString("ISB $%1 = %2").arg(ss, 2, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0xEF, ss, (int16_t)(addr >> 8) };//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("ISB $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::ISC_zpX()
{
    ...
    LOG::Write(old_PC, ddd, QString("ISB $%1,X @ %2 = %3").arg(ss, 2, 16, QLatin1Char('0')).toUpper().arg(addr, 2, 16).arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::ISC_absY()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ISB $%1%2,Y @ %3 = %4").arg(((addr - Y) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - Y) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::ISC_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("ISB $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::LAX_indX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("LAX ($%1,X) @ %2 = %3 = %4").
                    arg(bus->read_cpu(old_PC + 1), 2, 16,QLatin1Char('0')).toUpper().
                    arg((bus->read_cpu(old_PC + 1) + old_X), 2, 16,QLatin1Char('0')).toUpper().
                    arg(addr, 4, 16,QLatin1Char('0')).toUpper().
                    arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
...
void CPU::LAX_abs()
{
    ...
    LOG::Write(old_PC, ddd, QString("LAX $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = bus->read_cpu(old_PC + 1);
    int16_t ddd[] = {0xB7, ss, -1};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("LAX $%1,Y @ %2 = %3").arg(ss, 2, 16,QLatin1Char('0')).toUpper().arg((addr) & 0xFF, 2, 16, QLatin1Char('0')).toUpper().arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
#if LOG_ON
    int16_t ss = (addr) & 0xFF;
    int16_t ddd[] = {0x8F, ss, int16_t(addr >> 8)};//ORA $10 = 00
    LOG::Write(old_PC, ddd, QString("SAX $%1 = %2").arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
...
void CPU::SAX_zpY()
{
    ...
    LOG::Write(old_PC, ddd, QString("SAX $%1,Y @ %2 = %3").arg(ss, 2, 16,QLatin1Char('0')).toUpper().arg((addr) & 0xFF, 2, 16, QLatin1Char('0')).toUpper().arg(val, 2, 16, QLatin1Char('0')).toUpper(), old_A, old_X, old_Y, old_status, old_SP, old_cycles);
    #endif
}
...
void CPU::SHY_absX()
{
    ...
    LOG::Write(old_PC, ddd,
               QString("SHY $%1%2,X @ %3 = %4").arg(((addr - X) >> 8), 2, 16,QLatin1Char('0')).toUpper().arg((addr - X) & 0xFF, 2, 16,QLatin1Char('0')).toUpper().arg(addr, 4, 16,QLatin1Char('0')).toUpper().arg(val, 2, 16,QLatin1Char('0')).toUpper(),
               old_A, old_X, old_Y, old_status, old_SP, old_cycles);
#endif
}
